...
Those trapped electron in the NV center behaves like a small magnet with a spin. The spin state can be 0 or 1 for a two level qubit system. When you shine a green laser on NV center, photons are absorbed and emits fluroscence (usually red photons).If th electron is in 0 state, bright red light is emitted. If the electron is in 1 state, the fluorscence emitted is dimmer.
...
1. **Silicon vacancy (SiV)**
2. **Germanium vacancy (GeV)**
3. **Tin Vacancy (SnV) or Lead Vacancy (PbV)**
4. **Chromium related or nickel related defects**
